...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210926_wcanvas_c4de07d4b17111a93322_20210926194311_archive.zip';
	const ARCHIVE_SIZE		 = '77023877';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'c4de07d-26194311';
    const SECONDARY_PACKAGE_HASH = 'ebb0434-26194311';
	const VERSION			 = '1.4.3';
